...
import './App.css'
import { getLinks } from './store.ts'
import type { Link } from './store.ts'
import Admin from './Admin.tsx'

function App() {
  const [links] = useState<Link[]>(getLinks())
    ...
    <div className="app">
      ...
      <main className="container" id="main-content" tabIndex={-1}>
          ...
          <div className="avatar-wrapper">
            ...
            <div className="avatar">
              <svg
                ...
                role="img"
                aria-label="Ripperoni's avatar"
              >
                <circle cx="50" cy="35" r="22" fill="currentColor" opacity="0.9" />
                <path
                  d="M12 92c0-21 17-38 38-38s38 17 38 38"
                  stroke="currentColor"
                  strokeWidth="8"
                  fill="none"
                  opacity="0.9"
        ...
        <div className="links">
          {links.map((link) => (
            <a
              ...
              className="link-card"
              style={{ '--gradient': link.gradient } as React.CSSProperties}
        ...
        <div className="socials">
          <a
            href="https://github.com/TheRipperoni"
            target="_blank"
            rel="noopener noreferrer"
